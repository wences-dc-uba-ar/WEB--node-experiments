...
export class StoreApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public create(data: any = undefined): Observable<Store> {
   ...
   * </em>
   */
  public upsert(data: any = undefined): Observable<Store> {
   ...
   * </em>
   */
  public upsertWithWhere(where: any = undefined, data: any = undefined): Observable<Store> {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public findById(id: any, filter: LoopBackFilter = undefined): Observable<Store> {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/stores/:id";
    let routeParams: any = {
   ...
   * </em>
   */
  public find(filter: LoopBackFilter = undefined): Observable<Array<Store>> {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/stores";
    let routeParams: any = {};
    ...
    if (filter) urlParams.filter = filter;
    let result = this.request(method, url, routeParams, urlParams, postBody);
    return result.map((instances: Array<Store>) =>
        instances.map((instance: Store) => new Store(instance))
    );
  }
   ...
   * </em>
   */
  public findOne(filter: LoopBackFilter = undefined): Observable<Store> {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/stores/findOne";
    let routeParams: any = {};
   ...
   * </em>
   */
  public createMany(data: Array<any> = undefined): Observable<Array<Store>> {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/stores";
    let routeParams: any = {};
